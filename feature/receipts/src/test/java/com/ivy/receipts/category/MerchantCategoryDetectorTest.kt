...
class MerchantCategoryDetectorTest {
    ...
    @Test
    fun `should detect ALDI as groceries`() = runBlocking {
        val blocks = listOf(
    ...
    @Test
    fun `should detect DM as health and personal care`() = runBlocking {
        val blocks = listOf(
    ...
    @Test
    fun `should match with partial keyword match`() = runBlocking {
        val blocks = listOf(
    ...
    @Test
    fun `should return null when merchant not found`() = runBlocking {
        val blocks = listOf(
    ...
    @Test
    fun `should return null when no matching category exists`() = runBlocking {
        val blocks = listOf(
